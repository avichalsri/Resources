...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(){
       ...
       JLabel l4=new JLabel("NAME");
        ...
        try{
            conn c=new conn();
            String str="select * from room where avaibility='"+"Available"+"'";
        ...
        l11.setBounds(20,350,150,20);
        add(l11);
        t7=new JTextField();
        t7.setBounds(200,350,150,25);
        add(t7);
    ...
    public void actionPerformed(ActionEvent ae){
       ...
       String name=t2.getText();
        ...
        String str2="insert into roomalloted values("+"'"+id1+"','"+room+"','"+price+"','"+deposit+"','"+inday+"','"+"NA"+"')";
        //System.out.println(str3);
        String str="insert into customer values("+"'"+id1+"',"+"'"+number1+"',"+"'"+name+"',"+"'"+gender+"',"+"'"+country+"',"+"'"+room+"','"+inday+"','"+"NA"+"')";
       String str1="update room set avaibility='Occupied' where roomno="+"'"+room+"'";
        try{
           conn c=new conn();
           ...
           try{
              conn c=new conn();
              String str="select * from room  where roomno='"+c2.getSelectedItem()+"'";
              ResultSet rs=c.s.executeQuery(str);
              while(rs.next()){
