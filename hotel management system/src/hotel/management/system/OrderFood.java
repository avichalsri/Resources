...
public class OrderFood extends JFrame implements ActionListener{
    ...
    OrderFood(){
        ...
        JLabel l1=new JLabel("ORDER FOOD");
       ...
       /* JLabel l4=new JLabel("NAME");
        ...
        try{
            conn c=new conn();
            String str="select * from food where avaibility='"+"Available"+"'";
        ...
        //l8.setForeground(Color.blue);
        l8.setBounds(20,270,150,20);
        add(l8);
        t4=new JTextField();
        t4.setBounds(200,270,150,25);
        add(t4);
        
        JLabel l9=new JLabel("DATE");
        l9.setFont(new Font("Tahoma",Font.PLAIN,16));
        //l9.setForeground(Color.blue);
        l9.setBounds(20,310,150,20);
        add(l9);
        t5=new JTextField();
        t5.setBounds(200,310,150,25);
        add(t5);
    ...
    public void actionPerformed(ActionEvent ae){
       ...
       // String name=t2.getText();
        ...
        String str2="insert into foodcustomer values("+"'"+id1+"','"+name+"','"+price+"','"+deposit+"','"+inday+"')";
        //String str="select * from customer where id='"+id1+"'";
      // String str1="update driver set avaibility='Occupied' where aadhar="+"'"+name+"'";
        try{
           conn c=new conn();
          /* ResultSet rs=c.s.executeQuery(str);
           int cnt=0;
       ...
       //}
        /*else if(ae.getSource()==b5){
           ...
           try{
              conn c=new conn();
              String str="select * from food  where name='"+c2.getSelectedItem()+"'";
              ResultSet rs=c.s.executeQuery(str);
              while(rs.next()){
