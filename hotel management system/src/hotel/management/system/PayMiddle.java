...
public class PayMiddle extends JFrame implements ActionListener{
    JComboBox c1,c11;
    JTextField tt1,tt2,tt3,tt4,tt5,tt6,tt7,tt8,tt9,tt10,tt11,tt12,tt13,tt14,tt15;
    Choice c4;
    JCheckBox c2;
    JButton b1,b2,b5;
    JTable t1,t2,t3;
    PayMiddle(){
        ...
        JLabel l1=new JLabel("MAKE PAYMENT");
        ...
        if(ae.getSource()==b5){
            ...
            try{
               ...
               String ss="";
                ...
                JOptionPane.showMessageDialog(null,"Paid Successfully, Remaining '"+x+"' has to pay");
